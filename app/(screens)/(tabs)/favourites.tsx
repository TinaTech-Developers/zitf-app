    ...
    <SafeAreaView className="flex-1">
      <View className="flex-1 mt-10 p-4 bg-white">
        ...
        <View className="flex flex-col items-center mt-4">
          ...
          <FavouritesLink heading="My Exhibitors (0)" link={"/favorites"} />
          <View className="w-[100%] h-[2px] bg-[#003366] my-1" />
          <FavouritesLink heading="My Events (0)" link={"/favorites"} />
          <View className="w-[100%] h-[2.5px] bg-[#003366] my-1" />
          <FavouritesLink heading="Route Planner (0)" link={"/favorites"} />
          <View className="w-[100%] h-[2px] bg-[#003366] my-1" />
        </View>
      </View>
    </SafeAreaView>
