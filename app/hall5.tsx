          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
            <View className="flex flex-row gap-4">
              <TouchableOpacity className="w-40 p-2 bg-green-500 rounded-lg h-11">
                <Text className="text-center text-white text-xl">whatsapp</Text>
              </TouchableOpacity>
              <TouchableOpacity className="flex flex-row items-center justify-center gap-4 w-40 p-2 bg-[#1877F2] rounded-lg h-11">
                ...
                <Text className="text-center text-white text-xl">Facebook</Text>
              </TouchableOpacity>
              <TouchableOpacity className="w-40 p-2 bg-blue-500 rounded-lg h-11">
                <Text className="text-center text-white text-xl">Email us</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>
